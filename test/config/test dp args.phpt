...
Configuration: %s
 ...
 50% . [32;1mScriptFUSIONTest\Pip\CapabilitiesTest::testDataProvider%S with data%S[0m [32m(%d ms)[0m
100% . [32;1mScriptFUSIONTest\Pip\CapabilitiesTest::testDataProvider%S with data%S[0m [32m(%d ms)[0m
