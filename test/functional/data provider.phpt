...
Configuration: %s
 ...
 50% . [32;1mScriptFUSIONTest\Pip\CapabilitiesTest::testDataProvider(@foo)? with data (set "foo")?('bar')[0m [32m(%d ms)[0m
100% . [32;1mScriptFUSIONTest\Pip\CapabilitiesTest::testDataProvider(#0)? with data (set #0)?('baz')[0m [32m(%d ms)[0m
